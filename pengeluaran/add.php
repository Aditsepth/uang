...
<body style="margin: 123px;padding: 11px;height: 700px;width: 730px;">
    ...
    <div>
                <h1 style="height: 54px;margin: 36px;width: 1005px;padding: -60px;">Tambah Data Pengeluaran </h1>
            </div>
...
<div id class="row">
  <div class="col-md-12" style="height: 504px;margin: 100px;padding: -10px;">
        ...
        <div class="form-group">
                <label for="no_keungan">No Pengeluaran</label>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="text" name="ket_pengeluaran" id="ket_pengeluaran" class="form-control" required>
            </div>
        ...
        if(isset($_POST['submit'])){
            ...
            $cek = mysqli_query($con, "SELECT * FROM tb_pengeluaran WHERE no_keungan='$no_keungan'") or die(mysqli_error($con));
            
            if(mysqli_num_rows($cek) == 0){
                $sql = mysqli_query($con, "INSERT INTO tb_pengeluaran(no_keungan, tgl_pengeluaran, pengeluaran, ket_pengeluaran) VALUES('$no_keungan', '$tgl_pengeluaran', '$pengeluaran', '$ket_pengeluaran')") or die(mysqli_error($con));
                
                if($sql){
                    echo '<script>alert("Berhasil menambahkan data."); document.location="pengeluaran.php";</script>';
                }else{
