...
$result = mysqli_query($con, "SELECT * FROM tb_pendapatan WHERE no_keungan = '$id'"); 
...
<body style="margin: 123px;padding: 11px;height: 700px;width: 730px;">
    ...
    <div>
                <h1 style="height: 54px;margin: 36px;width: 1005px;padding: -60px;">Edit Data Suhu Ruangan Weighing 1</h1>
            </div>
...
<div class="row">
  <div class="col-md-12" style="height: 504px;margin: 100px;padding: -10px;">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="tgl_pendapatan">Tanggal Pendaptan</label>
                <input type="date" name="tgl_pendapatan" value="<?=$data['tgl_pendapatan'] ?>" id="tgl_pendapatan" class="form-control" required>
            </div>
             <div class="form-group">
                <label for="pendapatan">Pendapatan</label>
                <input type="text" name="pendapatan" value="<?=$data['pendapatan'] ?>" id="pendapatan" class="form-control" required>
            </div>
             <div class="form-group">
                <label for="ket_pendapatan">Keterangan</label>
                <input type="text" name="ket_pendapatan" value="<?=$data['ket_pendapatan'] ?>" id="ket_pendapatan" class="form-control" required>
            </div>
